...
$vio = mysqli_query($conn,"select * from course where course_id='$cid'");
...
<a href="logout.php"><i class="fa-power-off fa"></i> Log Out</a><br><br>
  ...
  <div class="col-md-12 py-4" style="background: #F2F9FF;">
						<h2 style="padding-left:1em;"><?php print $v['course']; ?></h2>
  ...
  <div class="col-md-12 py-4" style="padding-left:2em;"> 
  	<div id="London" class="city">
		...
		<div class="card col-md-12" align="left" style="border-radius:13px;">
			...
			<span class="title">Table of Content</span><hr>

			<?php
		
		$cos = mysqli_query($conn, "select * from subjects where course_id='$cid' ");
		...
		?>
				...
				<?php if($i==0) { 
     $i=1;
     $link = "learning.php?sub=".$learn['subject_id']."&course_id=".$learn['course_id']."&page=1";
	 $class = "none";
		$cursor = "pointer";
		$color = "blue";
		
			$p = mysqli_query($conn,"select * from progress where user_id='$user_id' AND subject_id='".$learn['subject_id']."'");
		...
		$button = "<a href=learning.php?sub=".$learn['subject_id']."&course_id=".$learn['course_id']."&page=1"." class='btn btn-primary'>Start Class</a>";
	 ...
	 ?>
			<a href="<?php print $link; ?>" style=" text-decoration:<?php print $class; ?>; cursor: <?php print $cursor; ?>; color:<?php print $color; ?>"> -	<?php print $learn['subject']; ?> <?php print $icon; ?> </a></p>
				<hr>
				<?php
		}
		?>
		<div align="right"><?php print $button; ?></div>
  			</div>
		</div>
