...
<a href="logout.php"><i class="fa-power-off fa"></i> Log Out</a><br><br>
  ...
  <div class="col-md-12 py-4" style="background: #F2F9FF;">
						<h2 style="padding-left:1em;">Our Courses</h2>
  ...
  <div class="col-md-12 py-4" style="padding-left:2em;"> 
  	<div id="London" class="city">
		...
		$cos = mysqli_query($conn, "select * from course where status='Active' ");
		
		while($learn = mysqli_fetch_assoc($cos)){
		?>
		
		<div class="card col-md-4" align="left" style="border-radius:13px;">
			<div class="card-body" align="left">
  				<h4><?php print $learn['course']; ?></h4>
				<img src="banner/<?php print $learn['banner']; ?>" style="width: 100%; height: 130px;"><hr>
				<div class="" style=" padding:;margin: auto; height:80px;"><strong>Batch Date: <?php print $learn['course_date']; ?></strong>
				<hr>
				<div align="right"><h5><a href="" class="">Join Batch</a></h5></div>
				</div>
  			</div>
		</div>
		<?php
