...
<head>
  ...
  <title>About Githan Academy</title>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav mx-lg-auto">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="about.php"><i class="fa-info-circle fa"></i> About</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container py-md-5 py-3">
      <div class="cwp4-two align-items-center">
        <div class="abouthyn-inn text-center">
          ...
          <p class="ab-para">Lorem ipsum dolor sit amet, consectetur adipisicingelit, sed do eiusmod tempor incididunt
            ut labore et
            dolore magna aliqua. Ut enim ad
            minim veniam,Semper at tempufddfel. Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum
            dolor sit amet.
          </p>
        ...
        <div class="faq-page col-lg-6 mb-lg-0 mb-4">
          ...
          <ul>
            <li>
              ...
              <i></i>
              <h4>Tempore Adipisicing elit</h4>
          ...
          <div class="slider-info">
            ...
            <div class="message-info">
              ...
              <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id
                ...
                quibusdam tenetur.Nulla mollis dapibus nunc, ut rhoncus turpis sodales quis. </div>
              <div class="name">- Johnson</div>
              <div class="desp">Patient ,City</div>
            </div>
          </div>
        </div>
        <div class="item">
